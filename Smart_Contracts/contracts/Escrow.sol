...
contract Escrow {
    ...
    modifier onlySeller(uint256 _id) {
        require(msg.sender == idToSeller[_id], "Only seller can call this function");
        _;
    }
    ...
    function depositLendMoney(uint256 _id) public payable onlyLender {
        require(isListed[_id], "The item is not yet listed");
        require(msg.value >= listing_price[_id] - escrow_amount[_id], "Not enough funds sent");
    ...
    function buyProperty(uint256 _id) public payable {
        ...
        require(lender_approved[_id][msg.sender], "Lender has not approved the transaction");
        require(msg.value >= escrow_amount[_id], "Not enough down payment");
        
        buyer_paid[_id] = true;
        require(lender_paid[_id], "Lender has not paid yet");
        require(address(this).balance >= listing_price[_id], "Not enough funds in escrow");
